const Sidebar = () => {
    return (
        <div className="flex flex-col min-h-screen w-1/4 gap-5 justify-between border-r border-gray-300">
            ...
            <div className="w-full h-60 bg-white flex flex-col">
